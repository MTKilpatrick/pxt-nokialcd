...
namespace nokialcd {
    ...
    const uint8_t CHAR_BYTES[600] = {
        ...
        0x63, 0x33, 0x18, 0x0c, 0x66, 0x63, // percent
        ...
        0x7f, 0x7f, 0x41, 0x41, 0x41, 0x00, // square bracket
        0x02, 0x06, 0x0c, 0x18, 0x30, 0x20, // backslash
        0x00, 0x41, 0x41, 0x41, 0x7f, 0x7f, // square bracket
        0x0c, 0x06, 0x03, 0x03, 0x06, 0x0c, // caret
        0x40, 0x40, 0x40, 0x40, 0x40, 0x40, // underscore
        0x00, 0x00, 0x03, 0x07, 0x04, 0x00, // back quote
        ...
        0x7c, 0x7c, 0x18, 0x18, 0x7c, 0x7c, //m
        ...
        0x7c, 0x7c, 0x08, 0x04, 0x0c, 0x08, //r
        0x48, 0x5c, 0x54, 0x54, 0x74, 0x24, //s
        0x04, 0x3f, 0x7f, 0x44, 0x44, 0x00, //t
        0x3c, 0x7c, 0x40, 0x40, 0x7c, 0x7c, //u
        0x1c, 0x3c, 0x60, 0x60, 0x3c, 0x1c, //v
        0x7c, 0x7c, 0x30, 0x70, 0x7c, 0x3c, //w
        0x44, 0x6c, 0x38, 0x38, 0x6c, 0x44, //x
        0x1c, 0xbc, 0xa0, 0xa0, 0xfc, 0x7c, //y
        0x44, 0x64, 0x74, 0x5c, 0x4c, 0x44, //z
        0x00, 0x08, 0x3e, 0x77, 0x41, 0x00, //{
        0x00, 0x00, 0x7f, 0x7f, 0x00, 0x00, //|
        0x00, 0x41, 0x77, 0x3e, 0x08, 0x00, //}
        0x06, 0x01, 0x02, 0x04, 0x03, 0x00, //~
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, // DEL = 127
        0x14, 0x3e, 0x7f, 0x55, 0x41, 0x22, // € Euro = 128 
        0x48, 0x5c, 0x55, 0x57, 0x75, 0x24, // S-hackek š = 154
        0x48, 0x7e, 0x7f, 0x49, 0x4b, 0x42, // pound £ = 163
        0x08, 0x08, 0x2a, 0x2a, 0x08, 0x08, // divide ÷ = 247
    };
    ...
    int charMap(int charNum) {
        ...
        if (charNum <  129)
            ...
            if (charNum == 154) return 129 - 32;
            if (charNum == 163) return 130 - 32;
            if (charNum == 247) return 131 - 32;
            return 0;
        }
    }
